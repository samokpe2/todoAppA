                            ...
                            <div class="max-w-5xl text-center">
                                ...
                                <div class="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8">
                                    ...
                                    <div class="p-6 bg-white shadow-lg rounded-lg transition-transform transform hover:scale-105">
                                        ...
                                        <h3 class="mt-4 text-2xl font-semibold">Smart Task Scheduling</h3>
                                    ...
                                    <div class="p-6 bg-white shadow-lg rounded-lg transition-transform transform hover:scale-105">
                                        ...
                                        <p class="mt-2 text-lg text-gray-600">Gain insights into your productivity with detailed reports.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
